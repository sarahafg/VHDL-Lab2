...
HD_PWD='/tools/Xilinx/Vivado/2018.3/bin/lab2/lab2.runs/datapath_alu_control_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log datapath_alu_control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source datapath_alu_control_0_0.tcl
