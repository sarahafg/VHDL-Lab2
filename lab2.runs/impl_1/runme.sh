...
HD_PWD='/tools/Xilinx/Vivado/2018.3/bin/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_comp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevel_comp.tcl -notrace
