...
HD_PWD='/tools/Xilinx/Vivado/2018.3/bin/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_comp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_comp.tcl
